...
class IngredientResourceIT {
    ...
    public static Ingredient createEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().name(DEFAULT_NAME).amount(DEFAULT_AMOUNT);
        return ingredient;
    }
    ...
    public static Ingredient createUpdatedEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().name(UPDATED_NAME).amount(UPDATED_AMOUNT);
        return ingredient;
    }
    ...
    void putNewIngredient() throws Exception {
        ...
        updatedIngredient.name(UPDATED_NAME).amount(UPDATED_AMOUNT);
    ...
    void partialUpdateIngredientWithPatch() throws Exception {
        ...
        partialUpdatedIngredient.name(UPDATED_NAME).amount(UPDATED_AMOUNT);
