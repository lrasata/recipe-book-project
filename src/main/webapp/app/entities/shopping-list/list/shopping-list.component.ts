...
export class ShoppingListComponent implements OnInit {
  ...
  constructor(protected shoppingListService: ShoppingListService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.shoppingLists = [];
    ...
    this.shoppingListService
      ...
      .subscribe({
        next: (res: HttpResponse<IShoppingList[]>) => {
          ...
          this.paginateShoppingLists(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
